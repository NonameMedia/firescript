  ...
  describe('tokenize()', () => {
    ...
    it('tokenize a .fire script, location enabled', () => {
      ...
      inspect(token).isEql([
        ...
        { type: 'identifier', value: 'extends', loc: { start: [ 3, 13 ], end: [ 3, 20 ] } },
        ...
        { type: 'punctation', value: '(', loc: { start: [ 7, 7 ], end: [ 7, 8 ] } },
        { type: 'punctation', value: ')', loc: { start: [ 7, 8 ], end: [ 7, 9 ] } },
        { type: 'indention', value: 4, loc: { start: [ 8, 0 ], end: [ 8, 4 ] } },
        { type: 'identifier', value: 'this', loc: { start: [ 8, 4 ], end: [ 8, 8 ] } },
        { type: 'punctation', value: '.', loc: { start: [ 8, 8 ], end: [ 8, 9 ] } },
        { type: 'identifier', value: '__isPeeled', loc: { start: [ 8, 9 ], end: [ 8, 19 ] } },
        { type: 'punctation', value: '=', loc: { start: [ 8, 20 ], end: [ 8, 21 ] } },
        { type: 'identifier', value: 'true', loc: { start: [ 8, 22 ], end: [ 8, 26 ] } },
